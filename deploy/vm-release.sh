...
upsert_env LIFECYCLE_HOT_WINDOW_MS "1800000"
upsert_env LIFECYCLE_SINGLE_FALLBACK_CONCURRENCY "4"
upsert_env LIFECYCLE_SINGLE_FALLBACK_MAX "20"
upsert_env LIFECYCLE_SINGLE_FALLBACK_TIMEOUT_MS "5000"
